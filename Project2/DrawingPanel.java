...
public class DrawingPanel implements ActionListener {
    private static final String versionMessage = "Drawing Panel version 1.1, January 25, 2015";
    ...
    public static void UpdateLabel(String statement) {
        //label.setText(statement);

        /*
        label.setFont(new Font("Verdana",1,10));
        p.panel.add(label);
        p.panel.setBorder(new LineBorder(Color.BLACK)); // make it easy to see
